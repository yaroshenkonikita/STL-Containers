...
struct ComparatorMap {
  bool operator()(const std::pair<Key, Value> &a,
                  const std::pair<Key, Value> &b) const noexcept {
...
template <typename Key, typename Value, typename Compare = std::less<Key>>
class map
    : public set<std::pair<Key, Value>, ComparatorMap<Key, Value, Compare>> {
  class MapIterator;
 ...
 public:
  ...
  using node_type =
      typename BinaryTree<std::pair<Key, Value>,
                          ComparatorMap<Key, Value, Compare>>::node_type;
  using pointer = node_type *;
  using iterator = MapIterator;
  using const_iterator = const MapIterator;
  using set_typename =
      set<std::pair<Key, Value>, ComparatorMap<Key, Value, Compare>>;
...
class map<Key, Value, Compare>::MapIterator {
 ...
 public:
  ...
  MapIterator(const MapIterator &other) noexcept : iterator(other.iterator) {}
...
map<Key, Value, Compare>::lower_bound(const key_type &key) {
  return set_typename::lower_bound(std::make_pair(key, Value()));
}

template <typename Key, typename Value, typename Compare>
typename map<Key, Value, Compare>::iterator
map<Key, Value, Compare>::upper_bound(const key_type &key) {
  return set_typename::upper_bound(std::make_pair(key, Value()));
}

template <typename Key, typename Value, typename Compare>
std::pair<typename map<Key, Value, Compare>::iterator,
          typename map<Key, Value, Compare>::iterator>
...
map<Key, Value, Compare>::insert(const Key &key, const Value &value) {
  std::pair<iterator, bool> insert =
      set_typename::insert(std::make_pair(key, value));
  return std::make_pair(std::move(MapIterator(insert.first)), insert.second);
}

template <typename Key, typename Value, typename Compare>
std::pair<typename map<Key, Value, Compare>::iterator, bool>
map<Key, Value, Compare>::insert(const std::pair<Key, Value> &item) {
...
template <typename Key, typename Value, typename Compare>
std::pair<typename map<Key, Value, Compare>::iterator, bool>
map<Key, Value, Compare>::insert_or_assign(const Key &key, const Value &value) {
...
template <typename Key, typename Value, typename Compare>
typename map<Key, Value, Compare>::size_type map<Key, Value, Compare>::count(
    const Key &key) {
...
typename map<Key, Value, Compare>::mapped_type &map<Key, Value, Compare>::at(
    const Key &key) const {
  typename set_typename::iterator current =
      set_typename::find(std::make_pair(key, Value()));
...
template <typename Key, typename Value, typename Compare>
template <typename... Args>
std::vector<std::pair<typename map<Key, Value, Compare>::iterator, bool>>
